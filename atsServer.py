    ...
    try:
        ...
        quick_response = {
            ...
            "quick_results": {
                ...
                "matched_skills_count": len(full_report["detailed_analysis"]["strong_matches"]),
                "missing_required_skills_count": len(full_report["detailed_analysis"]["missing_required"]),
                "missing_preferred_skills_count": len(full_report["detailed_analysis"]["missing_preferred"]),
                "top_recommendations": full_report["detailed_analysis"]["recommendations"][:3]
            }
        }
