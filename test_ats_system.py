...
class TestATSScorer:
    ...
    def test_extract_section(self, ats_scorer):
        ...
        required_section = ats_scorer._extract_section(sample_text, ['requirements', 'required'])
...
class TestATSIntegration:
    ...
    def test_parse_job_requirements_basic(self, ats_scorer):
        ...
        assert 'machine learning' in [skill.lower() for skill in requirements['required_skills']]
